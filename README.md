...
## Build
The project is built with Maven version 3.2.5 or later. See [Building this Project](https://github.com/FIXTradingCommunity/tablature/wiki/Building-this-Project)
