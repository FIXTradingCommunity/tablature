 ...
 * not conform to the grammar, the tester will report "mismatched input".
 *
...
public class InteractiveTest implements Runnable {
   ...
   *        <li>-g grammar name - defaults to {@code io.fixprotocol.md.antlr}</li>
   *        <li>-r start rule name - defaults to {@code document}</li>
   *        </ul>
  ...
  private static void usage() {
    System.err.println(
        "java io.fixprotocol.md.antlr.InteractiveTest [-i <fileName>] [-g <grammarName] [-r ruleName]");
    System.exit(1);
  }
